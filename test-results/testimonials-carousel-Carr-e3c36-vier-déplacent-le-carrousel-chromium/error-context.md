...
- Name: testimonials-carousel.spec.js >> Carrousel de témoignages >> les flèches gauche/droite du clavier déplacent le carrousel
- Location: tests/e2e/testimonials-carousel.spec.js:78:7
...
Locator: getByText(/2\s*(sur|of)\s*7/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/2\s*(sur|of)\s*7/i)
...
- main:
  ...
  - paragraph: Témoignage 1 sur 7, Kossi A.
