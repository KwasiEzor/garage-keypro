...
export const site = {
  ...
  address: {
    ...
    full: {
      fr: 'Adjidogomé Boukarou, Lomé — Togo',
      en: 'Adjidogomé Boukarou, Lomé — Togo',
    },
    short: { fr: 'Lomé, Togo', en: 'Lomé, Togo' },
  },

  // Coordonnées GPS du marqueur sur la carte.
  // ⚠️ Position approximative — reprise du repère précédent (Agoè-Nyivé),
  // une zone voisine, en attendant les coordonnées exactes de l'atelier à
  // Adjidogomé Boukarou. Remplacez par les coordonnées exactes (clic droit
  // sur Google Maps → « Plus d'infos sur cet endroit »).
  geo: {
    lat: 6.2094,
    lng: 1.2069,
    zoom: 14,
  ...
  // Langue utilisée quand ni le choix mémorisé du visiteur, ni la langue
  // de son navigateur, ne permettent de trancher. Réglable depuis
  // /admin/parametres.
  defaultLocale: 'fr',

  // Boutons flottants du site public. Réglables depuis /admin/parametres.
  showWhatsapp: true,
  // Masqué par défaut : à activer une fois un fournisseur IA configuré
  // (voir lib/ai-providers.js), ou pour n'utiliser que les réponses
  // préprogrammées de lib/dictionaries.js.
  showChatbot: false,
  // Fournisseur IA du chatbot (voir lib/ai-providers.js pour les valeurs
  // possibles). La clé d'API correspondante est en variable d'environnement.
