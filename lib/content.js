...
export async function loadContent() {
  ...
  try {
    ...
    const siteDb = {
      ...
      currency: s.currency,
      timezone: s.timezone || siteFile.timezone,
      defaultLocale: s.default_locale || siteFile.defaultLocale,
      showWhatsapp: s.show_whatsapp_button ?? siteFile.showWhatsapp,
      showChatbot: s.show_chatbot ?? siteFile.showChatbot,
      aiProvider: s.ai_provider || siteFile.aiProvider,
