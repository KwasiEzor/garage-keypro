  ...
  fr: {
    ...
    home: {
      ...
      testimonials: [
        ...
        {
          quote:
            'Clé cassée dans le contact un dimanche soir. Ils ont répondu tout de suite sur WhatsApp et sont venus la même heure. Sauvés.',
          name: 'Yawa K.',
          role: 'Bè · Peugeot 308',
        },
        {
          quote:
            "Devis clair envoyé avant toute intervention, prix honnête pour une clé à transpondeur — bien moins cher qu'au concessionnaire.",
          name: 'Edem T.',
          role: 'Adidogomé · Nissan Note',
        },
        {
          quote:
            'Notre camionnette de chantier ne pouvait plus démarrer un vendredi. Diagnostic sur place, pièce identifiée, réparée avant le week-end.',
          name: 'Ama S.',
          role: 'Baguida · Toyota Hilux',
        },
        {
          quote:
            "Accueil sérieux, explications en français et en anglais, aucun jargon pour me vendre plus cher. J'y retourne pour tout entretien clé.",
          name: 'Koffi N.',
          role: 'Hédzranawoé · Kia Picanto',
        },
      ],
      ...
      coverage: {
        ...
        text:
          "Notre atelier est à Adjidogomé Boukarou, mais notre unité mobile couvre l'ensemble de l'agglomération.",
      },
    },
    services: {
    ...
    about: {
      ...
      coverageText:
        'Atelier à Adjidogomé Boukarou et intervention mobile dans tout le Grand Lomé : Agoè-Nyivé, Bè, Tokoin, Hédzranawoé, Baguida, Avépozo et alentours. Au-delà de Lomé, contactez-nous pour vérifier la disponibilité.',
    ...
    contact: {
      ...
      map: {
        ...
        title: 'L’atelier à Adjidogomé Boukarou, Lomé',
        intro:
    ...
    footer: {
      ...
      ctaTitle: 'Besoin d’un devis rapide ?',
      ...
      sections: [
        {
          ...
          text: 'KEYPRO SERVICE CENTER, atelier situé à Adjidogomé Boukarou, Lomé (Togo), joignable à keyproservicecenter@gmail.com et au +228 72 11 44 44, est responsable du traitement des données décrites dans cette page.',
        },
        {
      ...
      sections: [
        {
          ...
          text: 'KEYPRO SERVICE CENTER — atelier de clés automobiles, programmation et diagnostic électronique. Adjidogomé Boukarou, Lomé, Togo.',
        },
        {
          title: 'Contact',
          text: 'keyproservicecenter@gmail.com — +228 72 11 44 44 / 98 48 88 44 / 22 46 66 26',
        },
        {
  ...
  en: {
    ...
    home: {
      ...
      testimonials: [
        ...
        {
          quote:
            'Key snapped in the ignition on a Sunday evening. They answered right away on WhatsApp and came within the hour. Lifesavers.',
          name: 'Yawa K.',
          role: 'Bè · Peugeot 308',
        },
        {
          quote:
            'Clear quote sent before any work started, fair price for a transponder key — much cheaper than the dealership.',
          name: 'Edem T.',
          role: 'Adidogomé · Nissan Note',
        },
        {
          quote:
            'Our work truck would not start on a Friday. On-site diagnosis, part identified, fixed before the weekend.',
          name: 'Ama S.',
          role: 'Baguida · Toyota Hilux',
        },
        {
          quote:
            'Professional welcome, explanations in both French and English, no jargon to oversell me. I go back for every key-related job.',
          name: 'Koffi N.',
          role: 'Hédzranawoé · Kia Picanto',
        },
      ],
      ...
      coverage: {
        ...
        text:
          'Our workshop is in Adjidogomé Boukarou, and our mobile unit covers the whole metropolitan area.',
      },
    },
    services: {
      eyebrow: 'Our work',
    ...
    about: {
      ...
      coverageText:
        'Workshop in Adjidogomé Boukarou and mobile call-outs across Greater Lomé: Agoè-Nyivé, Bè, Tokoin, Hédzranawoé, Baguida, Avépozo and surrounding areas. Outside Lomé, contact us to check availability.',
    ...
    contact: {
      ...
      map: {
        eyebrow: 'Find us',
        title: 'The workshop in Adjidogomé Boukarou, Lomé',
        intro:
      ...
      sections: [
        {
          ...
          text: 'KEYPRO SERVICE CENTER, a workshop located in Adjidogomé Boukarou, Lomé (Togo), reachable at keyproservicecenter@gmail.com and +228 72 11 44 44, is responsible for the processing described on this page.',
        },
        {
      ...
      sections: [
        {
          ...
          text: 'KEYPRO SERVICE CENTER — car key, programming and electronic diagnostics workshop. Adjidogomé Boukarou, Lomé, Togo.',
        },
        {
          title: 'Contact',
          text: 'keyproservicecenter@gmail.com — +228 72 11 44 44 / 98 48 88 44 / 22 46 66 26',
